...
codes = [{"code":"13p3.00","system":"readv2"},{"code":"13p4.00","system":"readv2"},{"code":"8I6H.00","system":"readv2"},{"code":"137V.00","system":"readv2"},{"code":"13p1.00","system":"readv2"},{"code":"137T.00","system":"readv2"},{"code":"13p2.00","system":"readv2"}];
REQUIRED_CODES = 1;
